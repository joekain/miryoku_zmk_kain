...
U_MTL(LGUI, Q),     U_MTL(LALT, S),     U_MTL(LCTRL, D),    U_MTL(LSHFT, F),    &kp G,             &kp H,             U_MTR(LSHFT, J),    U_MTR(LCTRL, K),    U_MTR(LALT, L),     U_MTR(LGUI, M),     \
...
U_MTL(LGUI, A),     U_MTL(LALT, R),     U_MTL(LCTRL, S),    U_MTL(LSHFT, T),    &kp D,             &kp H,             U_MTR(LSHFT, N),    U_MTR(LCTRL, E),    U_MTR(LALT, I),     U_MTR(LGUI, O),     \
...
&kp Q,             &kp W,             &kp F,             &kp P,             &kp B,             &kp J,             &kp L,             &kp U,             &kp Y,             &kp SQT,           \
U_MTL(LGUI, A),     U_MTL(LALT, R),     U_MTL(LCTRL, S),    U_MTL(LSHFT, T),    &kp G,             &kp K,             U_MTR(LSHFT, N),    U_MTR(LCTRL, E),    U_MTR(LALT, I),     U_MTR(LGUI, O),     \
...
U_MTL(LGUI, A),     U_MTL(LALT, O),     U_MTL(LCTRL, E),    U_MTL(LSHFT, U),    &kp I,             &kp D,             U_MTR(LSHFT, H),    U_MTR(LCTRL, T),    U_MTR(LALT, N),     U_MTR(LGUI, S),     \
...
U_MTL(LGUI, S),     U_MTL(LALT, H),     U_MTL(LCTRL, N),    U_MTL(LSHFT, T),    &kp COMMA,         &kp DOT,           U_MTR(LSHFT, A),    U_MTR(LCTRL, E),    U_MTR(LALT, O),     U_MTR(LGUI, I),     \
...
U_MTL(LGUI, A),     U_MTL(LALT, S),     U_MTL(LCTRL, H),    U_MTL(LSHFT, T),    &kp G,             &kp Y,             U_MTR(LSHFT, N),    U_MTR(LCTRL, E),    U_MTR(LALT, O),     U_MTR(LGUI, I),     \
